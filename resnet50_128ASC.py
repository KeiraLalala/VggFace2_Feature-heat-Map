...
class Resnet50_128(nn.Module):
    ...
    def forward_layer_0(self, data):
        ...
        return conv2_1_1x1_proj, conv2_1_1x1_increase_bn
    
    def forward_layer_1(self, conv2_1_1x1_proj, conv2_1_1x1_increase_bn):
    ...
    def forward_layer_2(self, conv2_2):
    ...
    def forward_layer_3(self, conv2_3):
        ...
        return conv3_1_1x1_proj, conv3_1_1x1_increase_bn
    
    def forward_layer_4(self, conv3_1_1x1_proj, conv3_1_1x1_increase_bn):
    ...
    def forward_layer_5(self, conv3_2):
    ...
    def forward_layer_6(self, conv3_3):
    ...
    def forward_layer_7(self, conv3_4):        
        ...
        return conv4_1_1x1_proj, conv4_1_1x1_increase_bn
    
    def forward_layer_8(self, conv3_4x, conv4_1_1x1_increase_bn):        
    ...
    def forward_layer_9(self, conv4_2):        
    ...
    def forward_layer_10(self, conv4_3):
    ...
    def forward_layer_11(self, conv4_4):
    ...
    def forward_layer_12(self, conv4_5):
    ...
    def forward_layer_13(self, conv4_6):
        ...
        return conv5_1_1x1_proj, conv5_1_1x1_increase_bn
    
    def forward_layer_14(self, conv5_1_1x1_proj, conv5_1_1x1_increase_bn):
    ...
    def forward_layer_15(self, conv5_2):
    ...
    def cho_layer(self, data, selected_layer):
        for layer in range(selected_layer+1):
            if layer == 0:
                data1, data2 = self.forward_layer_0(data)
            elif layer == 1:
                data = self.forward_layer_1(data1, data2)
            elif layer == 2:
                data = self.forward_layer_2(data)
            elif layer == 3:
                data1, data2 = self.forward_layer_3(data)
            elif layer == 4:
                data = self.forward_layer_4(data1, data2)
            elif layer == 5:
                data = self.forward_layer_5(data)
            elif layer == 6:
                data = self.forward_layer_6(data)
            elif layer == 7:
                data1, data2 = self.forward_layer_7(data)
            elif layer == 8:
                data = self.forward_layer_8(data1, data2)
            elif layer == 9:
                data = self.forward_layer_9(data)
            elif layer == 10:
                data = self.forward_layer_10(data)
            elif layer == 11:
                data = self.forward_layer_11(data)
            elif layer == 12:
                data = self.forward_layer_12(data)
            elif layer == 13:
                data1, data2 = self.forward_layer_13(data)
            elif layer == 14:
                data = self.forward_layer_14(data1, data2)
            elif layer == 15:
                data = self.forward_layer_15(data)
            return data
    def grad_layer(self, data, data2, layer):
        if layer == 0:
            data, data2 = self.forward_layer_0(data)
        elif layer == 1:
            data = self.forward_layer_1(data, data2)
        elif layer == 2:
            data = self.forward_layer_2(data)
        elif layer == 3:
            data, data2 = self.forward_layer_3(data)
        elif layer == 4:
            data = self.forward_layer_4(data, data2)
        elif layer == 5:
            data = self.forward_layer_5(data)
        elif layer == 6:
            data = self.forward_layer_6(data)
        elif layer == 7:
            data, data2 = self.forward_layer_7(data)
        elif layer == 8:
            data = self.forward_layer_8(data, data2)
        elif layer == 9:
            data = self.forward_layer_9(data)
        elif layer == 10:
            data = self.forward_layer_10(data)
            ...
            data, data2 = self.forward_layer_13(data)
        elif layer == 14:
            data = self.forward_layer_14(data, data2)
        elif layer == 15:
            data = self.forward_layer_15(data)
        return data, data2
    
    def classifier(self, data):
        pool5_7x7_s1 = self.pool5_7x7_s1(data)
